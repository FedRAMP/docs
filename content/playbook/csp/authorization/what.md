...
!!! warning "Required Formats"
    ...
    FedRAMP authorization package documents must be submitted in the designated formats (e.g., Microsoft Word and Excel), and some must be prepared using a FedRAMP-provided template. CSPs are required to complete and submit the [_FedRAMP Initial Authorization Package Checklist_](https://www.fedramp.gov/resources/templates/FedRAMP-Initial-Authorization-Package-Checklist.xlsx) to ensure that all documentation requirements are met. The checklist indicates required submission formats and templates and must be included with the initial authorization package.

!!! danger "Altering Content"
