...
!!! info "Effective Date(s) & Overall Applicability for Rev5"
      ...
      - Rev5 Authorized providers MAY adopt this process beginning February 2, 2026 if they are also participating in the Significant Change Notification and Vulnerability Detection and Response betas.
      ...
      - **Sign-up Form:** [https://docs.google.com/forms/d/e/1FAIpQLSdOH7qeJ9uPlb3zYN35qDPNOm_pXQ8sHanAZIIh5tdgjnubVw/viewform](https://docs.google.com/forms/d/e/1FAIpQLSdOH7qeJ9uPlb3zYN35qDPNOm_pXQ8sHanAZIIh5tdgjnubVw/viewform)
...
These requirements and recommendations apply to ALL cloud service offerings following the FedRAMP Rev5 path.

### Legacy Repository Exception

??? abstract "ADS-CSL-LRE"

    **Former ID:** FRR-ADS-EX-01
...
??? abstract "ADS-CSL-UCP"

    **Former ID:** FRR-ADS-06
...
??? abstract "ADS-CSL-TCM"

    **Former ID:** FRR-ADS-08
...
??? abstract "ADS-CSL-UTC"

    **Former ID:** ADS-CSX-UTC

    **Changelog:**

    - **2026-02-04:** Modified to should, clarified wider application; removed italics and changed the ID as part of new standardization in v0.9.0-beta; no material changes.
    - **2026-02-11:** Auto-fix: key &quot;ADS-CSX-UTC&quot; middle segment did not match parent &quot;CSL&quot;. Renamed to &quot;ADS-CSL-UTC&quot;.
...
!!! quote ""
    ...
    - _This recommendation only applies to FedRAMP Rev5 (it is required for FedRAMP 20x)._
