...
|-----------|---|-------------|---------|----------------|
| [Incident Communications Procedures (ICP)](https://github.com/FedRAMP/docs/tree/main/markdown/FRMR.ICP.incident-communications-procedures.md) | [[PDF]](https://github.com/FedRAMP/docs/blob/main/pdf/FRMR.ICP.incident-communications-procedures.pdf) | Initial release of simplified 20x version of this existing FedRAMP policy. | 25.11A | 2025-11-08 |
| [FedRAMP Definitions (FRD)](https://github.com/FedRAMP/docs/tree/main/markdown/FRMR.FRD.fedramp-definitions.md) | [[PDF]](https://github.com/FedRAMP/docs/blob/main/pdf/FRMR.FRD.fedramp-definitions.pdf) | Added FRD-ALL-40 (definition of incident) to support the 20x Incident Communications Procedures. | 25.11A | 2025-11-08 |
| [Using Cryptographic Modules Policy (UCM)](https://github.com/FedRAMP/docs/tree/main/markdown/FRMR.UCM.using-cryptographic-modules.md) | [[PDF]](https://github.com/FedRAMP/docs/blob/main/pdf/FRMR.UCM.using-cryptographic-modules.pdf) | Initial release of simplified 20x version of this existing FedRAMP policy. | 25.11A | 2025-11-08 |
