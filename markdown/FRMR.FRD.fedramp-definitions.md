...
#### FRD-ALL-01: Federal Customer Data
...
>
> Includes: federal customer data

#### FRD-ALL-02: Information Resource
...
>
> Includes: information resource, information resources
...
>
> Includes: handle, handles, handled, handling

#### FRD-ALL-04: Likely

> **Likely**: A reasonable degree of probability based on context.
>
> Includes: likely, likelihood

#### FRD-ALL-05: Third-party Information Resource
...
>
> Includes: third-party information resource, third-party information resources

#### FRD-ALL-06: Cloud Service Offering
...
>
> Includes: cloud service offering, cloud service offerings

#### FRD-ALL-07: Regularly
...
>
> Includes: regularly, regular

#### FRD-ALL-08: Significant change
...
>
> Includes: significant change, significant changes

#### FRD-ALL-09: Routine Recurring
...
#### FRD-ALL-12: Impact Categorization
...
>
> Includes: impact categorization

#### FRD-ALL-13: Interim Requirement
...
#### FRD-ALL-14: Authorization Package
...
>
> Includes: authorization package, authorization packages

#### FRD-ALL-15: Authorization data
...
>
> Includes: trust center, trust centers

#### FRD-ALL-17: Machine-Readable
...
#### FRD-ALL-18: All Necessary Parties
...
>
> Includes: all necessary parties
...
>
> Includes: agency, agencies

#### FRD-ALL-20: Vulnerability
...
>
> Includes: vulnerability, vulnerabilities

#### FRD-ALL-21: Vulnerability Detection
...
>
> Includes: vulnerability detection, detect vulnerabilities, detect, detection, detected

#### FRD-ALL-22: Vulnerability Response
...
>
> Includes: vulnerability response, respond to vulnerabilities, respond, response, responded

#### FRD-ALL-23: Likely Exploitable Vulnerability (LEV)
...
>
> Includes: likely exploitable vulnerability, likely exploitable vulnerabilities, LEV, LEVs, NLEV, NLEVs

#### FRD-ALL-24: Internet-Reachable Vulnerability (IRV)
...
>
> Includes: internet-reachable vulnerability, internet-reachable vulnerabilities, IRV, IRVs, NIRV, NIRVs

#### FRD-ALL-25: Known Exploited Vulnerability (KEV)
...
>
> Includes: known exploited vulnerability, known exploited vulnerabilities, KEV, KEVs

#### FRD-ALL-26: Remediated Vulnerability

> **Remediated Vulnerability**: A _vulnerability_ that has been neutralized or eliminated and is no longer _detected_.
>
> Includes: remediated vulnerability, remediated vulnerabilities

#### FRD-ALL-27: Partially Mitigated Vulnerability
...
>
> Includes: partially mitigated vulnerability, partially mitigated vulnerabilities

#### FRD-ALL-28: Fully Mitigated Vulnerability
...
>
> Includes: fully mitigated vulnerability, fully mitigated vulnerabilities

#### FRD-ALL-29: False Positive Vulnerability
...
>
> Includes: false positive vulnerability, false positive vulnerabilities

#### FRD-ALL-30: Overdue Vulnerability
...
>
> Includes: overdue vulnerability, overdue vulnerabilities

#### FRD-ALL-31: Accepted Vulnerability
...
>
> Includes: accepted vulnerability, accepted vulnerabilities

#### FRD-ALL-32: Catastrophic Adverse Effect
...
>
> Includes: catastrophic adverse effect, catastrophic adverse effects

#### FRD-ALL-33: Serious Adverse Effect
...
>
> Includes: serious adverse effect, serious adverse effects

#### FRD-ALL-34: Limited Adverse Effect
...
>
> Includes: limited adverse effect, limited adverse effects

#### FRD-ALL-35: Negligible Adverse Effect
...
>
> Includes: negligible adverse effect, negligible adverse effects

#### FRD-ALL-36: Potential Adverse Impact (of vulnerability exploitation)
...
>
> Includes: potential adverse impact, potential adverse impacts
...
>
> Includes: promptly, prompt

#### FRD-ALL-38: Persistently
...
>
> Includes: persistently, persistent
...
>
> Includes: drift, drifts, drifting
...
>
> Includes: incident, incidents

#### FRD-ALL-41: Top-level administrative account
...
>
> Includes: top-level administrative account, top-level administrative accounts

#### FRD-ALL-42: Privileged account
...
>
> Includes: privileged account, privileged accounts

#### FRD-ALL-43: Ongoing Authorization Report (OAR)
...
>
> Includes: ongoing authorization report, OAR, OARs

#### FRD-ALL-44: Quarterly Review
...
>
> Includes: quarterly review, quarterly reviews
