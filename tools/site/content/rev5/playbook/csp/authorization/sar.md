...
**_Table 6\. FedRAMP SAR Artifacts_**

|                                                                                                                                                                                                                                                                                                                     |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| SAR\* Appendix A: Risk Exposure Table (RET)\* Appendix B: Security Requirements Traceability Matrix (SRTM) Workbook\* Appendix C: Vulnerability Scan Results Appendix D: Documentation Review Findings Appendix E: Auxiliary Documents Appendix F: Penetration Test Report Evidence collected during the assessment |
