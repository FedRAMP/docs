...
**_Table 5\. FedRAMP SAP Artifacts_**

|                                                                                                                                                                                                      |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SAP\* Appendix A: Security Controls Selection Worksheet\* Appendix B: Sampling Methodology Appendix C: Penetration Testing Plan and Methodology Appendix D: Significant Change Request Documentation |
...
- Does the 3PAO intend to use a sampling methodology? If so, was the methodology included as an appendix to the SAP? For vulnerability scans, the 3PAO’s sampling methodology must align with the [_FedRAMP Guide for Determining Eligibility and Requirements for the Use of Sampling for Vulnerability Scans_](https://www.fedramp.gov/resources/documents/CSP_Vulnerability_Scan_Requirements_Using_Sampling.pdf).
