...
Federal agency authorizing official (AO) representatives, and contractors working on their behalf, may request temporary (60-day) access to a CSO’s repository for the purpose of reviewing the authorization package in order to inform a risk-based authorization decision. Access requests are submitted to FedRAMP via the [_FedRAMP Package Access Request Form_](https://www.fedramp.gov/resources/documents/Agency_Package_Request_Form.pdf). In addition to the form, agency contractors must sign the nondisclosure agreement embedded as an attachment within the form.  
